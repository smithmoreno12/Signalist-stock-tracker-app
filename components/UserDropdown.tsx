    ...
    <DropdownMenu>
      <DropdownMenuTrigger
        render={
          <Button
            variant="ghost"
            className={
              "felx items-center gap-4 text-gray-400 hover:text-yellow-500"
            }
          />
        }
      >
      ...
      <DropdownMenuContent className={"text-gray-400"}>
        ...
        <DropdownMenuItem
          ...
          className={
            "text-gray-100 text-md font-medium focus:bg-transparent focus:text-yellow-500 transition-colors cursor-pointer"
          }
        >
